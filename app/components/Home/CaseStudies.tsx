                  ...
                  {f.tags && f.tags.length > 0 && (
                    <div className="flex flex-wrap gap-2 mb-4">
                      {f.tags.slice(0, 2).map((tag) => (
                        <span
                          key={tag}
                          className="inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-gray-50 to-gray-100 text-gray-700 rounded-lg text-xs font-medium border border-gray-200/60 hover:from-primary-50 hover:to-primary-100 hover:border-primary-200 hover:text-primary-700 transition-all duration-200"
                        >
      ...
      {open && (
        ...
        >
          <div className="max-w-4xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto">
            {/* Modal Header */}
            <div className="relative h-[60vh] bg-gradient-to-br from-slate-900 via-primary-900 to-slate-800">
              {open.image && (
                <img
                  src={open.image}
                  alt={open.title}
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white">
                <div className="flex items-center gap-3 mb-3">
                  {open.featured && (
                    <div className="bg-gradient-to-r from-primary-500 to-orange-500 text-white px-3 py-1 rounded-full text-sm font-bold">
                      Featured
                    </div>
                  )}
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-primary-600 to-primary-800 text-white rounded-xl font-semibold hover:from-primary-700 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
                >
