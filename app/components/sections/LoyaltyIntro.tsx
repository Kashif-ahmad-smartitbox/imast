...
export default function LoyaltyIntro({ data }: { data: Data }) {
  const {
    ...
    description = "At IMAST, we design loyalty programs that not only strengthen relationships but also inspire advocacy. We combine behavioral insights, strategy, and cutting-edge technology to build systems that sustain brand love and maximize ROI.",
    imageSrc = "/images/loyalty-intro.png",
    imageAlt = "Customer interacting with IMAST loyalty program",
    background = "#fff7fb",
    accentColor = "#9b28a0",
    reverse = false,
    cards = [],
