...
export default function VerticalsCarousel({ data }: VerticalsCarouselProps) {
  const {
    ...
    subtitle = "IMAST Retail Point caters to a multitude of retail sectors with its range of POS software solutions, tailored to single or multi-store licenses across various industries.",
    items = [],
    bgColor = "#b73e96",
    cardBg = "#ffffff",
    cardRadius = "24px",
